...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "ALetter", "symbols": ["_", "symbol", "_"], "postprocess": ([w1,l]) => ({symbol: l, params: undefined})},
    {"name": "ALetter", "symbols": ["_", "symbol", {"literal":"("}, "AxiomParams", {"literal":")"}, "_"], "postprocess": ([w1,l,x,p]) => ({symbol: l, params: p})},
